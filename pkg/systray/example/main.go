...
/*
This is an example application to see how the systray lib is used.
Dependencies: gtk3, libappindicator-gtk3
*/
func main() {
	onExit := func() {
		// now := time.Now()
...
func onReady() {
	...
	go func() {
		...
		for {
			select {
			case <-mCheckbox.ClickedCh:
				mChange.SetTitle("Yeah")
